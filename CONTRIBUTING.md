# Contributing to MkLume

MkLume is open source and contributions are welcome. Whether you're reporting a bug, suggesting a feature, or submitting code, your input helps improve the project for everyone.
...
You will need **Node.js** (v18+), **Rust** (latest stable), and the [Tauri v2 prerequisites](https://v2.tauri.app/start/prerequisites/) installed on your system.
...
If you are unsure about anything, feel free to [open an issue](https://github.com/ECalStudios/mklume/issues) and ask.
